        ...
        builder: (context, snapshot) {
          ...
          return FutureBuilder<DocumentSnapshot>(
            ...
            builder: (context, pilotDeviceSnapshot) {
              if (pilotDeviceSnapshot.connectionState ==
              ...
              if (pilotDeviceSnapshot.hasError) {
                return Center(
                    child: Text('Error: ${pilotDeviceSnapshot.error}'));
              }

              if (!pilotDeviceSnapshot.hasData ||
                  !pilotDeviceSnapshot.data!.exists) {
                return Center(child: Text('Pilot device data not found'));
              }

              // Ambil data dari koleksi 'pilot-device-1'
              final pilotDeviceData =
                  pilotDeviceSnapshot.data!.data() as Map<String, dynamic>;
              ...
              return FutureBuilder<DocumentSnapshot>(
                ...
                builder: (context, userDeviceSnapshot) {
                  if (userDeviceSnapshot.connectionState ==
                      ConnectionState.waiting) {
                    return Center(child: CircularProgressIndicator());
                  }
                  ...
                  if (userDeviceSnapshot.hasError) {
                    return Center(
                        child: Text('Error: ${userDeviceSnapshot.error}'));
                  }

                  if (!userDeviceSnapshot.hasData ||
                      !userDeviceSnapshot.data!.exists) {
                  ...
                  final userData =
                      userDeviceSnapshot.data?.data() as Map<String, dynamic> ??
                          {};
                      ...
                      child: Column(
                        ...
                        children: [
                          Align(
                            ...
                            child: Text(_formatTimestamp(date),
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment
                                    .start, // Agar teks tetap di kiri
                                children: [
                                  Center(
                                    child: Text("BATTERY INTEGRITY",
                          ...
                          Container(
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Center(
                                    child: Text("BRACKET (RAM-MOUNT) INTEGRITY",
                                        style: tsOneTextTheme.titleMedium),
                                  ),
                                  Divider(
                                    color: Colors.grey,
                          ...
                          Container(
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Center(
                                    child: Text("EFB SOFTWARE INTEGRITY",
                                        style: tsOneTextTheme.titleMedium),
                                  ),
                                  Divider(
                                    color: Colors.grey,
                                    ...
                                    generateFeedbackForm(
                                      ...
                                      additionalComment:
                                          feedbackData['additionalComment'] ??
                                              '-',
                                      devicename1:
                                          pilotDeviceData['device_name'] ?? '-',
                                      devicename2:
                                          pilotDeviceData['device_name2'] ??
                                              '-',
                                      devicename3:
                                          pilotDeviceData['device_name3'] ??
                                              '-',
                                      userName:
...
Future<List<Map<String, dynamic>>> getAllFeedbackData() async {
  ...
  for (QueryDocumentSnapshot doc in feedbackQuerySnapshot.docs) {
    ...
    QuerySnapshot feedbackDeviceQuerySnapshot = await FirebaseFirestore.instance
        .collection('feedback-device')
        .where('feedback_id', isEqualTo: feedbackId)
        .get();
    ...
    if (feedbackDeviceQuerySnapshot.docs.isNotEmpty) {
      ...
      DocumentSnapshot feedbackDocument =
          feedbackDeviceQuerySnapshot.docs.first;
      Map<String, dynamic> feedbackData =
          feedbackDocument.data() as Map<String, dynamic>;
