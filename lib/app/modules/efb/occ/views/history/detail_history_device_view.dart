      ...
      body: SingleChildScrollView(
        child: FutureBuilder<DocumentSnapshot>(
          ...
          builder: (context, snapshot) {
            ...
            final status = data['status-device-1'];
              ...
              builder: (context, userSnapshot) {
                ...
                return FutureBuilder<DocumentSnapshot>(
                  future: handoverTo != null
                      ? FirebaseFirestore.instance.collection("users").doc(handoverTo).get()
                      : Future.value(null),
                      ...
                      builder: (context, deviceSnapshot) {
                        ...
                        final deviceData = deviceSnapshot.data!.data() as Map<String, dynamic>;
                          ...
                          return FutureBuilder<DocumentSnapshot>(
                              ...
                              ? FirebaseFirestore.instance.collection("users").doc(occOnDuty).get()
                                  : Future.value(null),
                              builder: (context, occOnDutySnapshot) {
                                ...
                                final occOnDutyuserData =
                                occOnDutySnapshot.data?.data() as Map<String, dynamic>?;
