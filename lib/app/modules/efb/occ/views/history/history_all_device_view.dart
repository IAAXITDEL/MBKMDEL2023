...
class _HistoryAllDeviceViewState extends State<HistoryAllDeviceView> {
  ...
  Future<void> exportToExcel(List<Map<String, dynamic>> data) async {
    ...
    sheet.cell(CellIndex.indexByColumnRow(columnIndex: 19, rowIndex: 0)).value =
        'Device 3';
    sheet.cell(CellIndex.indexByColumnRow(columnIndex: 20, rowIndex: 0)).value =
        'IOS Version (3nd)';
    sheet.cell(CellIndex.indexByColumnRow(columnIndex: 21, rowIndex: 0)).value =
        'Flysmart Version (3nd)';
    sheet.cell(CellIndex.indexByColumnRow(columnIndex: 22, rowIndex: 0)).value =
        'Docunet Version (3nd)';
    sheet.cell(CellIndex.indexByColumnRow(columnIndex: 23, rowIndex: 0)).value =
        'LiDo Version (3nd)';
    sheet.cell(CellIndex.indexByColumnRow(columnIndex: 24, rowIndex: 0)).value =
        'HUB (3nd)';
    sheet.cell(CellIndex.indexByColumnRow(columnIndex: 25, rowIndex: 0)).value =
        'Condition (3nd)';
    sheet.cell(CellIndex.indexByColumnRow(columnIndex: 26, rowIndex: 0)).value =
        'Status';
    sheet.cell(CellIndex.indexByColumnRow(columnIndex: 27, rowIndex: 0)).value =
        'OCC On Duty (ID)';
    sheet.cell(CellIndex.indexByColumnRow(columnIndex: 28, rowIndex: 0)).value =
        'OCC On Duty (Name)';
    sheet.cell(CellIndex.indexByColumnRow(columnIndex: 29, rowIndex: 0)).value =
        'OCC On Duty (HUB)';
    sheet.cell(CellIndex.indexByColumnRow(columnIndex: 30, rowIndex: 0)).value =
        'OCC Accept (ID)';
    sheet.cell(CellIndex.indexByColumnRow(columnIndex: 31, rowIndex: 0)).value =
        'OCC Accept (Name)';
    sheet.cell(CellIndex.indexByColumnRow(columnIndex: 32, rowIndex: 0)).value =
        'OCC Accept (HUB)';
    sheet.cell(CellIndex.indexByColumnRow(columnIndex: 33, rowIndex: 0)).value =
        'Handover To (ID)';
    sheet.cell(CellIndex.indexByColumnRow(columnIndex: 34, rowIndex: 0)).value =
        'Handover To (Name)';
    sheet.cell(CellIndex.indexByColumnRow(columnIndex: 35, rowIndex: 0)).value =
        'Handover To (Rank)';
    sheet.cell(CellIndex.indexByColumnRow(columnIndex: 36, rowIndex: 0)).value =
        'Handover To (HUB)';
    ...
    for (var i = 0; i < devicesData.length; i++) {
      ...
      DocumentSnapshot userSnapshot =
          await usersCollection.doc(device['user_uid']).get();
      ...
      DocumentSnapshot occgivenSnapshot =
          await usersCollection.doc(device['occ-on-duty']).get();
      Map<String, dynamic> occgivenData =
          occgivenSnapshot.data() as Map<String, dynamic>;
      ...
      if (device['occ-accepted-device'] != null &&
          device['occ-accepted-device'] != '-') {
        // If device_uid is not '-', get the 'iosver'
        DocumentSnapshot userSnapshot =
            await usersCollection.doc(device['occ-accepted-device']).get();
        Map<String, dynamic> userData =
            userSnapshot.data() as Map<String, dynamic>;
      ...
      if (device['handover-to-crew'] != null &&
          device['handover-to-crew'] != '-') {
        // If device_uid is not '-', get the 'iosver'
        DocumentSnapshot userSnapshot =
            await usersCollection.doc(device['handover-to-crew']).get();
        Map<String, dynamic> userData =
            userSnapshot.data() as Map<String, dynamic>;
      ...
      if (device['device_uid'] != null && device['device_uid'] != '-') {
        ...
        DocumentSnapshot deviceSnapshot =
            await devicesCollection.doc(device['device_uid']).get();
      ...
      if (device['device_uid2'] != null && device['device_uid2'] != '-') {
        // If device_uid is not '-', get the 'iosver'
        DocumentSnapshot device2Snapshot =
            await devicesCollection.doc(device['device_uid2']).get();
        Map<String, dynamic> deviceData =
            device2Snapshot.data() as Map<String, dynamic>;
      ...
      if (device['device_uid3'] != null && device['device_uid3'] != '-') {
        // If device_uid is not '-', get the 'iosver'
        DocumentSnapshot device3Snapshot =
            await devicesCollection.doc(device['device_uid3']).get();
        Map<String, dynamic> deviceData =
            device3Snapshot.data() as Map<String, dynamic>;
      ...
      String deviceName = (device['device_name'] ?? '-') == '-'
          ? '-'
          : device['device_name'] ?? '-';
      String deviceName2 = (device['device_name2'] ?? '-') == '-'
          ? '-'
          : device['device_name2'] ?? '-';
      String deviceName3 = (device['device_name3'] ?? '-') == '-'
          ? '-'
          : device['device_name3'] ?? '-';
      String OccAccepted = (device['occ-accepted-device'] ?? '-') == '-'
          ? '-'
          : device['occ-accepted-device'] ?? '-';
      String HandoverToCrew = (device['handover-to-crew'] ?? '-') == '-'
          ? '-'
          : device['handover-to-crew'] ?? '-';
      ...
      sheet
          ...
          .value = condition2;
      sheet
          .cell(CellIndex.indexByColumnRow(columnIndex: 19, rowIndex: i + 1))
          .value = deviceName3;
      sheet
          .cell(CellIndex.indexByColumnRow(columnIndex: 20, rowIndex: i + 1))
          .value = iosVersion3;
      sheet
          .cell(CellIndex.indexByColumnRow(columnIndex: 21, rowIndex: i + 1))
          .value = flysmartVersion3;
      sheet
          .cell(CellIndex.indexByColumnRow(columnIndex: 22, rowIndex: i + 1))
          .value = docuVersion3;
      sheet
          .cell(CellIndex.indexByColumnRow(columnIndex: 23, rowIndex: i + 1))
          .value = lidoVersion3;
      sheet
          .cell(CellIndex.indexByColumnRow(columnIndex: 24, rowIndex: i + 1))
          .value = hub3;
      sheet
          .cell(CellIndex.indexByColumnRow(columnIndex: 25, rowIndex: i + 1))
          .value = condition3;
      sheet
          .cell(CellIndex.indexByColumnRow(columnIndex: 26, rowIndex: i + 1))
          .value = device['statusDevice'];
      sheet
          .cell(CellIndex.indexByColumnRow(columnIndex: 27, rowIndex: i + 1))
          .value = device['occ-on-duty'];
      sheet
          .cell(CellIndex.indexByColumnRow(columnIndex: 28, rowIndex: i + 1))
          .value = occName;
      sheet
          .cell(CellIndex.indexByColumnRow(columnIndex: 29, rowIndex: i + 1))
          .value = occHub;
      sheet
          .cell(CellIndex.indexByColumnRow(columnIndex: 30, rowIndex: i + 1))
          .value = OccAccepted;
      sheet
          .cell(CellIndex.indexByColumnRow(columnIndex: 31, rowIndex: i + 1))
          .value = occAcceptedName;
      sheet
          .cell(CellIndex.indexByColumnRow(columnIndex: 32, rowIndex: i + 1))
          .value = occAcceptedHub;
      sheet
          .cell(CellIndex.indexByColumnRow(columnIndex: 33, rowIndex: i + 1))
          .value = HandoverToCrew;
      sheet
          .cell(CellIndex.indexByColumnRow(columnIndex: 34, rowIndex: i + 1))
          .value = handoverToName;
      sheet
          .cell(CellIndex.indexByColumnRow(columnIndex: 35, rowIndex: i + 1))
          .value = handoverToHub;
      sheet
          .cell(CellIndex.indexByColumnRow(columnIndex: 36, rowIndex: i + 1))
          .value = handoverToRank;
    }
  ...
  Future<List<Map<String, dynamic>>> fetchDataFromFirebase() async {
    QuerySnapshot querySnapshot =
        await FirebaseFirestore.instance.collection('pilot-device-1').get();
