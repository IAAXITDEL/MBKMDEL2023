...
class _AnalyticsScreenState extends State<AnalyticsScreen> {
  ...
  void initState() {
    assessmentResultsviewModel =
        Provider.of<AssessmentResultsViewModel>(context, listen: false);
    assessmentViewModel =
    ...
    descBarChart =
        "Assessment Results from ${Util.convertDateTimeDisplay(startDate.toString())} to ${Util.convertDateTimeDisplay(endDate.toString())}";
  ...
  void getAllAssessmentResultsFromRemote() async {
    assessmentResults =
        await assessmentResultsviewModel.getAllAssessmentResults();
  ...
  void getAllAssessmentVariablesFromTheLatestAssessmentPeriod() async {
    ...
    for (AssessmentVariables assessmentVariable in assessmentVariables) {
      if (assessmentVariable.category !=
          AssessmentVariables.keyAdvanceManeuvers) {
        mapOfAssessmentVariableResultsCount.add({
          ...
          AssessmentVariables.keyTypeOfAssessment:
              assessmentVariable.typeOfAssessment,
          'Unsatisfactory': 0,
          'Satisfactory': 0,
          'N/A': 0,
          'Markers 1': 0,
    ...
    for (AssessmentVariables humanfactorAssessmentVariable
        in humanFactorAssessmentVariables) {
      mapOfHumanFactorAssessmentVariableResultsCount.add({
        ...
        AssessmentVariables.keyTypeOfAssessment:
            humanfactorAssessmentVariable.typeOfAssessment,
        'N/A': 0,
        'PF Markers 1': 0,
        'PF Markers 2': 0,
        'PF Markers 3': 0,
  ...
  void getCountOfEachAssessmentVariableResultsPerMarker() async {
    for (AssessmentResults assessmentResult
        in assessmentResultsFilteredByDate) {
      for (int i = 0; i < assessmentResult.variableResults.length; i++) {
        for (int j = 0; j < mapOfAssessmentVariableResultsCount.length; j++) {
          if (assessmentResult.variableResults[i].assessmentVariableId ==
              mapOfAssessmentVariableResultsCount[j]
                  [AssessmentVariables.keyId]) {
            if (assessmentResult.variableResults[i].isNotApplicable) {
              mapOfAssessmentVariableResultsCount[j]['N/A']++;
              continue;
            }
            if (assessmentResult.variableResults[i].assessmentType ==
                AssessmentVariables.keySatisfactory) {
              if (assessmentResult.variableResults[i].assessmentSatisfactory ==
                  AssessmentVariables.keySatisfactory) {
              ...
              switch (
                  assessmentResult.variableResults[i].pilotMonitoringMarkers) {
                case 1:
                  mapOfAssessmentVariableResultsCount[j]['Markers 1']++;
                  break;
                case 2:
        ...
        for (int j = 0;
            j < mapOfHumanFactorAssessmentVariableResultsCount.length;
            j++) {
          if (assessmentResult.variableResults[i].assessmentVariableId ==
              mapOfHumanFactorAssessmentVariableResultsCount[j]
                  [AssessmentVariables.keyId]) {
            if (assessmentResult.variableResults[i].isNotApplicable) {
    ...
    if (assessmentResultsFilteredByDate.isNotEmpty) {
      for (int i = 0; i < mapOfAssessmentVariableResultsCount.length; i++) {
        mapOfAssessmentVariableResultsCount[i]['Original Markers 1'] =
            mapOfAssessmentVariableResultsCount[i]['Markers 1'];
        mapOfAssessmentVariableResultsCount[i]['Original Markers 2'] =
            mapOfAssessmentVariableResultsCount[i]['Markers 2'];
        mapOfAssessmentVariableResultsCount[i]['Original Markers 3'] =
            mapOfAssessmentVariableResultsCount[i]['Markers 3'];
        mapOfAssessmentVariableResultsCount[i]['Original Markers 4'] =
            mapOfAssessmentVariableResultsCount[i]['Markers 4'];
        mapOfAssessmentVariableResultsCount[i]['Original Markers 5'] =
            mapOfAssessmentVariableResultsCount[i]['Markers 5'];
      }
      for (int i = 0;
          i < mapOfHumanFactorAssessmentVariableResultsCount.length;
          i++) {
        mapOfHumanFactorAssessmentVariableResultsCount[i]
                ['Original PF Markers 1'] =
            mapOfHumanFactorAssessmentVariableResultsCount[i]['PF Markers 1'];
        mapOfHumanFactorAssessmentVariableResultsCount[i]
                ['Original PF Markers 2'] =
            mapOfHumanFactorAssessmentVariableResultsCount[i]['PF Markers 2'];
        mapOfHumanFactorAssessmentVariableResultsCount[i]
                ['Original PF Markers 3'] =
            mapOfHumanFactorAssessmentVariableResultsCount[i]['PF Markers 3'];
        mapOfHumanFactorAssessmentVariableResultsCount[i]
                ['Original PF Markers 4'] =
            mapOfHumanFactorAssessmentVariableResultsCount[i]['PF Markers 4'];
        mapOfHumanFactorAssessmentVariableResultsCount[i]
                ['Original PF Markers 5'] =
            mapOfHumanFactorAssessmentVariableResultsCount[i]['PF Markers 5'];

        mapOfHumanFactorAssessmentVariableResultsCount[i]
                ['Original PM Markers 1'] =
            mapOfHumanFactorAssessmentVariableResultsCount[i]['PM Markers 1'];
        mapOfHumanFactorAssessmentVariableResultsCount[i]
                ['Original PM Markers 2'] =
            mapOfHumanFactorAssessmentVariableResultsCount[i]['PM Markers 2'];
        mapOfHumanFactorAssessmentVariableResultsCount[i]
                ['Original PM Markers 3'] =
            mapOfHumanFactorAssessmentVariableResultsCount[i]['PM Markers 3'];
        mapOfHumanFactorAssessmentVariableResultsCount[i]
                ['Original PM Markers 4'] =
            mapOfHumanFactorAssessmentVariableResultsCount[i]['PM Markers 4'];
        mapOfHumanFactorAssessmentVariableResultsCount[i]
                ['Original PM Markers 5'] =
            mapOfHumanFactorAssessmentVariableResultsCount[i]['PM Markers 5'];
      }
    }
    ...
    if (assessmentResultsFilteredByDate.isNotEmpty) {
      for (int i = 0; i < mapOfAssessmentVariableResultsCount.length; i++) {
        if (mapOfAssessmentVariableResultsCount[i]['Total Markers'] == 0) {
          ...
          mapOfAssessmentVariableResultsCount[i]['Markers 1'] =
              (mapOfAssessmentVariableResultsCount[i]['Markers 1'] /
                  mapOfAssessmentVariableResultsCount[i]['Total Markers'] *
                  100);
          mapOfAssessmentVariableResultsCount[i]['Markers 2'] =
              (mapOfAssessmentVariableResultsCount[i]['Markers 2'] /
                  mapOfAssessmentVariableResultsCount[i]['Total Markers'] *
      ...
      for (int i = 0;
          i < mapOfHumanFactorAssessmentVariableResultsCount.length;
          i++) {
        if (mapOfHumanFactorAssessmentVariableResultsCount[i]
                ['Total PF Markers'] ==
            0) {
  ...
  void _selectStartingDate(BuildContext context) async {
    final DateTime? picked = await showDatePicker(
      context: context,
      initialDate:
          startDate == Util.defaultDateIfNull ? nowWithoutTime : startDate,
                        ...
                        children: [
                                ...
                                child: IconButton(
                                  ...
                                  onPressed: () async {
                                    try {
                                      ...
                                      excel.rename(defaultSheet!,
                                          allAssessmentSheetName);
                                      var allAssessmentSheet =
                                          excel[allAssessmentSheetName];
                                      ...
                                      // merge A1:T1
                                      allAssessmentSheet.merge(
                                          CellIndex.indexByString("A1"),
                                          CellIndex.indexByString("T1"));
                                      // then merge A2:T2
                                      allAssessmentSheet.merge(
                                          CellIndex.indexByString("A2"),
                                          CellIndex.indexByString("T2"));
                                      // finally merge A1:A2
                                      allAssessmentSheet.merge(
                                          CellIndex.indexByString("A1"),
                                          CellIndex.indexByString("A2"));
                                      // set value for A1
                                      var titleCell = allAssessmentSheet
                                      ...
                                      var categoryHeaderCell =
                                          allAssessmentSheet.cell(
                                              CellIndex.indexByString("A3"));
                                      categoryHeaderCell.value = "Category";
                                      categoryHeaderCell.cellStyle =
                                          headerCellStyle;
                                      ...
                                      // put "Subject" in B3
                                      var variableHeaderCell =
                                          allAssessmentSheet.cell(
                                              CellIndex.indexByString("B3"));
                                      variableHeaderCell.value = "Subject";
                                      variableHeaderCell.cellStyle =
                                          headerCellStyle;
                                      ...
                                      var assessmentHeaderCell =
                                          allAssessmentSheet.cell(
                                              CellIndex.indexByString("C3"));
                                      assessmentHeaderCell.value = "Assessment";
                                      assessmentHeaderCell.cellStyle =
                                          headerCellStyle;

                                      // put 3 items below "Assessment" in C4, D4, E4
                                      var unsatisfactoryHeaderCell =
                                          allAssessmentSheet.cell(
                                              CellIndex.indexByString("C4"));
                                      unsatisfactoryHeaderCell.value =
                                          "Unsatisfactory";
                                      unsatisfactoryHeaderCell.cellStyle =
                                          headerCellStyle;
                                      var satisfactoryHeaderCell =
                                          allAssessmentSheet.cell(
                                              CellIndex.indexByString("D4"));
                                      satisfactoryHeaderCell.value =
                                          "Satisfactory";
                                      satisfactoryHeaderCell.cellStyle =
                                          headerCellStyle;
                                      var notApplicableHeaderCell =
                                          allAssessmentSheet.cell(
                                              CellIndex.indexByString("E4"));
                                      notApplicableHeaderCell.value = "N/A";
                                      notApplicableHeaderCell.cellStyle =
                                          headerCellStyle;
                                      ...
                                      // put "Marker" in F3
                                      var markerHeaderCell = allAssessmentSheet
                                          .cell(CellIndex.indexByString("F3"));
                                      markerHeaderCell.value = "Marker";
                                      markerHeaderCell.cellStyle =
                                          headerCellStyle;

                                      // put 5 items below "Marker" in F4, G4, H4, I4, J4
                                      var marker1HeaderCell = allAssessmentSheet
                                          .cell(CellIndex.indexByString("F4"));
                                      marker1HeaderCell.value = "1";
                                      marker1HeaderCell.cellStyle =
                                          headerCellStyle;
                                      var marker2HeaderCell = allAssessmentSheet
                                          .cell(CellIndex.indexByString("G4"));
                                      marker2HeaderCell.value = "2";
                                      marker2HeaderCell.cellStyle =
                                          headerCellStyle;
                                      var marker3HeaderCell = allAssessmentSheet
                                          .cell(CellIndex.indexByString("H4"));
                                      marker3HeaderCell.value = "3";
                                      marker3HeaderCell.cellStyle =
                                          headerCellStyle;
                                      var marker4HeaderCell = allAssessmentSheet
                                          .cell(CellIndex.indexByString("I4"));
                                      marker4HeaderCell.value = "4";
                                      marker4HeaderCell.cellStyle =
                                          headerCellStyle;
                                      var marker5HeaderCell = allAssessmentSheet
                                          .cell(CellIndex.indexByString("J4"));
                                      marker5HeaderCell.value = "5";
                                      marker5HeaderCell.cellStyle =
                                          headerCellStyle;
                                      ...
                                      // put "PF" in K3
                                      var pfHeaderCell = allAssessmentSheet
                                          .cell(CellIndex.indexByString("K3"));
                                      pfHeaderCell.value = "PF";
                                      pfHeaderCell.cellStyle = headerCellStyle;

                                      // put 5 items below "PF" in K4, L4, M4, N4, O4
                                      var pf1HeaderCell = allAssessmentSheet
                                          .cell(CellIndex.indexByString("K4"));
                                      pf1HeaderCell.value = "1";
                                      pf1HeaderCell.cellStyle = headerCellStyle;
                                      var pf2HeaderCell = allAssessmentSheet
                                          .cell(CellIndex.indexByString("L4"));
                                      pf2HeaderCell.value = "2";
                                      pf2HeaderCell.cellStyle = headerCellStyle;
                                      var pf3HeaderCell = allAssessmentSheet
                                          .cell(CellIndex.indexByString("M4"));
                                      pf3HeaderCell.value = "3";
                                      pf3HeaderCell.cellStyle = headerCellStyle;
                                      var pf4HeaderCell = allAssessmentSheet
                                          .cell(CellIndex.indexByString("N4"));
                                      pf4HeaderCell.value = "4";
                                      pf4HeaderCell.cellStyle = headerCellStyle;
                                      var pf5HeaderCell = allAssessmentSheet
                                          .cell(CellIndex.indexByString("O4"));
                                      ...
                                      allAssessmentSheet.merge(
                                          ...
                                          CellIndex.indexByString("T3"));
                                      // put "PM" in P3
                                      var pmHeaderCell = allAssessmentSheet
                                          .cell(CellIndex.indexByString("P3"));
                                      pmHeaderCell.value = "PM";
                                      pmHeaderCell.cellStyle = headerCellStyle;

                                      // put 5 items below "PM" in P4, Q4, R4, S4, T4
                                      var pm1HeaderCell = allAssessmentSheet
                                          .cell(CellIndex.indexByString("P4"));
                                      pm1HeaderCell.value = "1";
                                      pm1HeaderCell.cellStyle = headerCellStyle;
                                      var pm2HeaderCell = allAssessmentSheet
                                          .cell(CellIndex.indexByString("Q4"));
                                      pm2HeaderCell.value = "2";
                                      pm2HeaderCell.cellStyle = headerCellStyle;
                                      var pm3HeaderCell = allAssessmentSheet
                                          .cell(CellIndex.indexByString("R4"));
                                      pm3HeaderCell.value = "3";
                                      pm3HeaderCell.cellStyle = headerCellStyle;
                                      var pm4HeaderCell = allAssessmentSheet
                                          .cell(CellIndex.indexByString("S4"));
                                      pm4HeaderCell.value = "4";
                                      pm4HeaderCell.cellStyle = headerCellStyle;
                                      var pm5HeaderCell = allAssessmentSheet
                                          .cell(CellIndex.indexByString("T4"));
                                      ...
                                      for (var assessmentCategory
                                          in AssessmentVariables
                                              .flightCategory) {
                                        if (assessmentCategory !=
                                          ...
                                          int count =
                                              0; // count of assessment variable will be the final position of merge

                                          // loop through the mapOfAssessmentVariableResultsCount to get the count of each assessment variable
                                          for (var map
                                              in mapOfAssessmentVariableResultsCount) {
                                            ...
                                            if (category ==
                                              ...
                                              var assessmentName = map[
                                                  AssessmentVariables.keyName];
                                              // put the assessment name in the cell
                                              var assessmentNameCell =
                                                  allAssessmentSheet.cell(
                                                      CellIndex.indexByString(
                                                          "B$index"));
                                              assessmentNameCell.value =
                                                  assessmentName;
                                              assessmentNameCell.cellStyle =
                                                  dataCellStyle;

                                              // get the assessment type
                                              var assessmentType = map[
                                                  AssessmentVariables
                                                      .keyTypeOfAssessment];
                                              if (assessmentType ==
                                                  AssessmentVariables
                                                      .keySatisfactory) {
                                                // get Unsatisfactory
                                                var unsatisfactoryCell =
                                                    allAssessmentSheet.cell(
                                                        CellIndex.indexByString(
                                                            "C$index"));
                                                unsatisfactoryCell.value =
                                                    map['Unsatisfactory'];
                                                unsatisfactoryCell.cellStyle =
                                                    dataCellStyle;

                                                // get Satisfactory
                                                var satisfactoryCell =
                                                    allAssessmentSheet.cell(
                                                        CellIndex.indexByString(
                                                            "D$index"));
                                                satisfactoryCell.value =
                                                    map['Satisfactory'];
                                                satisfactoryCell.cellStyle =
                                                    dataCellStyle;

                                                // get N/A
                                                var notApplicableCell =
                                                    allAssessmentSheet.cell(
                                                        CellIndex.indexByString(
                                                            "E$index"));
                                                notApplicableCell.value =
                                                    map['N/A'];
                                                notApplicableCell.cellStyle =
                                                    dataCellStyle;
                                                ...
                                                var marker1Cell =
                                                    allAssessmentSheet.cell(
                                                        CellIndex.indexByString(
                                                            "F$index"));
                                                marker1Cell.value =
                                                    map['Original Markers 1'];
                                                marker1Cell.cellStyle =
                                                    dataCellStyle;
                                                ...
                                                var marker2Cell =
                                                    allAssessmentSheet.cell(
                                                        CellIndex.indexByString(
                                                            "G$index"));
                                                marker2Cell.value =
                                                    map['Original Markers 2'];
                                                marker2Cell.cellStyle =
                                                    dataCellStyle;
                                                ...
                                                var marker3Cell =
                                                    allAssessmentSheet.cell(
                                                        CellIndex.indexByString(
                                                            "H$index"));
                                                marker3Cell.value =
                                                    map['Original Markers 3'];
                                                marker3Cell.cellStyle =
                                                    dataCellStyle;
                                                ...
                                                var marker4Cell =
                                                    allAssessmentSheet.cell(
                                                        CellIndex.indexByString(
                                                            "I$index"));
                                                marker4Cell.value =
                                                    map['Original Markers 4'];
                                                marker4Cell.cellStyle =
                                                    dataCellStyle;
                                                ...
                                                var marker5Cell =
                                                    allAssessmentSheet.cell(
                                                        CellIndex.indexByString(
                                                            "J$index"));
                                                marker5Cell.value =
                                                    map['Original Markers 5'];
                                                marker5Cell.cellStyle =
                                                    dataCellStyle;
                                              } else {
                                                // get N/A
                                                var notApplicableCell =
                                          ...
                                          allAssessmentSheet.merge(
                                              CellIndex.indexByString(
                                                  "A$initialPosition"),
                                              CellIndex.indexByString(
                                                  "A${initialPosition + count - 1}"));
                                          // put the assessment category in the cell
                                          var assessmentCategoryCell =
                                              allAssessmentSheet.cell(
                                                  CellIndex.indexByString(
                                                      "A$initialPosition"));
                                          assessmentCategoryCell.value =
                                              assessmentCategory;
                                          assessmentCategoryCell.cellStyle =
                                              CellStyle(
                                            horizontalAlign:
                                      ...
                                      for (var assessmentCategory
                                        ...
                                        // loop through the mapOfAssessmentVariableResultsCount to get the count of each assessment variable
                                        for (var map
                                            in mapOfHumanFactorAssessmentVariableResultsCount) {
                                          // get the category of the assessment variable
                                          var category = map[
                                              AssessmentVariables.keyCategory];
                                          if (category == assessmentCategory) {
                                            ...
                                            if (assessmentType ==
                                              ...
                                              // get PF Markers 1
                                              var pf1Cell = allAssessmentSheet
                                                  .cell(CellIndex.indexByString(
                                                      "K$index"));
                                              pf1Cell.value =
                                                  map['Original PF Markers 1'];
                                              pf1Cell.cellStyle = dataCellStyle;

                                              // get Original PF Markers 2
                                              var pf2Cell = allAssessmentSheet
                                                  .cell(CellIndex.indexByString(
                                                      "L$index"));
                                              pf2Cell.value =
                                                  map['Original PF Markers 2'];
                                              pf2Cell.cellStyle = dataCellStyle;

                                              // get Original PF Markers 3
                                              var pf3Cell = allAssessmentSheet
                                                  .cell(CellIndex.indexByString(
                                                      "M$index"));
                                              pf3Cell.value =
                                                  map['Original PF Markers 3'];
                                              pf3Cell.cellStyle = dataCellStyle;

                                              // get Original PF Markers 4
                                              var pf4Cell = allAssessmentSheet
                                                  .cell(CellIndex.indexByString(
                                                      "N$index"));
                                              pf4Cell.value =
                                                  map['Original PF Markers 4'];
                                              pf4Cell.cellStyle = dataCellStyle;

                                              // get Original PF Markers 5
                                              var pf5Cell = allAssessmentSheet
                                                  .cell(CellIndex.indexByString(
                                                      "O$index"));
                                              pf5Cell.value =
                                                  map['Original PF Markers 5'];
                                              pf5Cell.cellStyle = dataCellStyle;

                                              // get Original PM Markers 1
                                              var pm1Cell = allAssessmentSheet
                                                  .cell(CellIndex.indexByString(
                                                      "P$index"));
                                              pm1Cell.value =
                                                  map['Original PM Markers 1'];
                                              pm1Cell.cellStyle = dataCellStyle;

                                              // get Original PM Markers 2
                                              var pm2Cell = allAssessmentSheet
                                                  .cell(CellIndex.indexByString(
                                                      "Q$index"));
                                              pm2Cell.value =
                                                  map['Original PM Markers 2'];
                                              pm2Cell.cellStyle = dataCellStyle;

                                              // get Original PM Markers 3
                                              var pm3Cell = allAssessmentSheet
                                                  .cell(CellIndex.indexByString(
                                                      "R$index"));
                                              pm3Cell.value =
                                                  map['Original PM Markers 3'];
                                              pm3Cell.cellStyle = dataCellStyle;

                                              // get Original PM Markers 4
                                              var pm4Cell = allAssessmentSheet
                                                  .cell(CellIndex.indexByString(
                                                      "S$index"));
                                              pm4Cell.value =
                                                  map['Original PM Markers 4'];
                                              pm4Cell.cellStyle = dataCellStyle;

                                              // get Original PM Markers 5
                                              var pm5Cell = allAssessmentSheet
                                                  .cell(CellIndex.indexByString(
                                                      "T$index"));
                                              pm5Cell.value =
                                                  map['Original PM Markers 5'];
                                      ...
                                      final destinationPath =
                                          "${destinationDirectory.path}/Analytics.xlsx";
                                ...
                                child: IconButton(
                                  onPressed: () async {
                                    ...
                                    try {
                                      ...
                                      final bytesBarChartMainAssessment =
                                      ...
                                      final bytesBarChartHumanFactorPFAssessment =
                                          await screenshotController
                                              .captureFromWidget(
                                        MediaQuery(
                                          data: const MediaQueryData(),
                                          child: Padding(
                                            padding: const EdgeInsets.only(
                                                ...
                                                left: 0.0),
                                            child:
                                                barChartHumanFactorPFAssessment,
                                          ),
                                        ),
                                        pixelRatio: pixelRatio,
                                      ...
                                      final bytesBarChartHumanFactorPMAssessment =
                                          await screenshotController
                                              .captureFromWidget(
                                        MediaQuery(
                                          data: const MediaQueryData(),
                                          child: Padding(
                                            padding: const EdgeInsets.only(
                                                ...
                                                left: 0.0),
                                            child:
                                                barChartHumanFactorPMAssessment,
                                          ),
                                        ),
                                        pixelRatio: pixelRatio,
                                        targetSize: const Size(2000, 800),
                                        ...
                                        build: (pw.Context context) =>
                                          ...
                                          child: pw.Column(
                                              ...
                                              children: [
                                                ...
                                                pw.Image(
                                                  pw.MemoryImage(
                                                      bytesBarChartHumanFactorPFAssessment),
                                                ),
                                              ]),
                                        )),
                                      ));
                                        ...
                                        build: (pw.Context context) =>
                                          ...
                                          child: pw.Column(
                                              ...
                                              children: [
                                                ...
                                                pw.Image(
                                                  pw.MemoryImage(
                                                      bytesBarChartHumanFactorPMAssessment),
                                                ),
                                              ]),
                                        )),
                                      ));
                                      ...
                                      final directory =
                                          await getApplicationDocumentsDirectory();
                                      final fileName =
                                          "tsone_analytics_report_${Util.convertDateTimeDisplay(DateTime.now().toString(), 'yyyy-MM-dd-HH:mm:ss')}";
                                      final filePath =
                                      ...
                                      final destinationPath =
                                          '${destinationDirectory.path}/$fileName.pdf';
                                      await file.copy(destinationPath);
                                      ...
                                      ScaffoldMessenger.of(context)
                                        ...
                                        const SnackBar(
                                          content: Text(
                                              'Error occurred while saving PDF file'),
                                        ),
                                      );
                                    }
                                    progress?.dismiss();
                                  ...
                                  child: TypeAheadFormField<UserModel>(
                                    ...
                                    suggestionsCallback: (pattern) async {
                                      ...
                                      if (pattern.isNotEmpty) {
                                        usersSearched = await userViewModel
                                            .getUsersBySearchName(
                                                pattern.toTitleCase(), 5);
                          ...
                          model.isLoading
                              ...
                              : Column(
                                  children: [
                                    Text(
                                        "Currently showing analytics of ${assessmentResultsFilteredByDate.length} assessment results for "
                                        "${isSearchingByUser ? "\"${nameTextController.text}\" " : rank == rankList[0] ? "all ranks " : "the rank of $rank "}"
  ...
  void buildChart() {
    ...
    barChartMainAssessment = BarChart(BarChartData(
      maxY: 100,
                    ...
                    child: Transform.rotate(
                      ...
                      child: SideTitleWidget(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                                mapOfAssessmentVariableResultsCount[value
                                    .toInt()][AssessmentVariables.keyCategory],
                                style: const TextStyle(
                                  fontSize: 10,
                            ...
                            Text(
                                mapOfAssessmentVariableResultsCount[
                                    value.toInt()][AssessmentVariables.keyName],
                                style: const TextStyle(
                                  fontSize: 10,
                                  color: Colors.black,
                                ))
        ...
        for (var i = 0; i < mapOfAssessmentVariableResultsCount.length; i++)
          BarChartGroupData(
            ...
            barRods: [
              BarChartRodData(
                fromY: 0,
                toY: mapOfAssessmentVariableResultsCount[i]['Markers 1']
                    .toDouble(),
                color: Colors.red,
                width: barWidth,
              ...
              BarChartRodData(
                fromY: mapOfAssessmentVariableResultsCount[i]['Markers 1']
                    .toDouble(),
                toY: mapOfAssessmentVariableResultsCount[i]['Markers 1']
                        .toDouble() +
                    mapOfAssessmentVariableResultsCount[i]['Markers 2']
      ...
      barTouchData: BarTouchData(
        ...
        touchTooltipData: BarTouchTooltipData(
          ...
          getTooltipItem: (group, groupIndex, rod, rodIndex) {
            String variableName =
                mapOfAssessmentVariableResultsCount[group.x.toInt()]
                    [AssessmentVariables.keyName];
            String markerName = "";
            if (rodIndex == 0) {
    ...
    barChartHumanFactorPFAssessment = BarChart(BarChartData(
      titlesData: FlTitlesData(
        show: true,
        leftTitles: AxisTitles(
          sideTitles: SideTitles(
        ...
        for (var i = 0;
          ...
          BarChartGroupData(
            ...
            barRods: [
              BarChartRodData(
                fromY: 0,
                toY: mapOfHumanFactorAssessmentVariableResultsCount[i]
                        ['PF Markers 1']
                    .toDouble(),
                color: Colors.red,
                width: barWidth,
              ...
              BarChartRodData(
                fromY: mapOfHumanFactorAssessmentVariableResultsCount[i]
                        ['PF Markers 1']
                    .toDouble(),
                toY: mapOfHumanFactorAssessmentVariableResultsCount[i]
                            ['PF Markers 1']
      ...
      barTouchData: BarTouchData(
        ...
        touchTooltipData: BarTouchTooltipData(
          ...
          getTooltipItem: (group, groupIndex, rod, rodIndex) {
            String variableName =
                mapOfHumanFactorAssessmentVariableResultsCount[group.x.toInt()]
                    [AssessmentVariables.keyName];
            String markerName = "";
            if (rodIndex == 0) {
    ...
    barChartHumanFactorPMAssessment = BarChart(BarChartData(
      titlesData: FlTitlesData(
        show: true,
        leftTitles: AxisTitles(
          sideTitles: SideTitles(
